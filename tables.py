...
\end{{flushright}}\par
\begin{{scriptsize}}
'''.format(tm, bm, oddim, oddom, ephem.date(date).datetime().strftime("%Y %B %d"), ephem.date(date+2).datetime().strftime("%b. %d"), rightindent) #date+2 deleted from ephem.date(date+2).datatime
    page = page + str1
    if config.tbls == "m":
